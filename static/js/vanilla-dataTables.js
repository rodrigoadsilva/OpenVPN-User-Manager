...
(function(root, factory) {
    ...
    var defaultConfig = {
        ...
        labels: {
            placeholder: "Procurar...", // The search input placeholder
            perPage: "Registros por página - {select}", // per-page dropdown label
            noRows: "Sem registro encontrado", // Message shown when there are no search results
